...
const BLOG = {
  ...
  GREETING_WORDS:
    ...
    '如果你感受到一点点慰藉和温暖，那么这便是我的目的',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '木小风', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '我与我周旋久，宁作我', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://crystal_cc.com', // 网站地址
